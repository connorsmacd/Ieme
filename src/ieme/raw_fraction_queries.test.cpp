  ...
  "[raw_fraction]")
{
  ...
  const auto rf2 = raw_fraction(-5, 2);
...
{
  const auto rf1 = raw_fraction(12, 32);
...
TEST_CASE("A raw fraction can be queried about whether or not it's reduced",
          "[raw_fraction]")
{
  const auto rf1 = raw_fraction(3, 4);
          ...
          "[raw_fraction]")
{
  ...
  const auto rf2 = raw_fraction(-3, 4);
